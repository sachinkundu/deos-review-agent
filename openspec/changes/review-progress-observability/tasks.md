...
- [x] 5.3 Attach deterministic and real-run evidence to the final ready-for-review implementation PR, verify the PR head and provider-visible evidence, and complete the checklist.
